...
?>
    ...
    <form method="post">
        ...
        <input type="number" name="pr1" min="0" max="10" required>

        <label>Práctica 2:</label>
        <input type="number" name="pr2" min="0" max="10" required>

        <label>Práctica 3:</label>
        <input type="number" name="pr3" min="0" max="10" required>

        <label>Práctica 4:</label>
        <input type="number" name="pr4" min="0" max="10" required>

        <h3>Notas de exámenes</h3>
        <label>Examen 1:</label>
        <input type="number" name="ex1" min="0" max="10" required>

        <label>Examen 2:</label>
        <input type="number" name="ex2" min="0" max="10" required>
